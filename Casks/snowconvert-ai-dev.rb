cask "snowconvert-ai-dev" do
  ...
  version "2.19.0-rc.155"

  arch_suffix = Hardware::CPU.intel? ? "x64" : "arm64"

  if Hardware::CPU.intel?
    sha256 "4b052f8b281a2c6cec8ca6e2ec7fa6f7f0a95838ea07d079d0b5ecc9624efd08"
  else
    sha256 "c04abe3d2623ed2de17242060445bc7697b12d268844f2c2f0c7def08933e4fc"
  end
