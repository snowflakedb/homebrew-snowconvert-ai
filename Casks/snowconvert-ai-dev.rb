cask "snowconvert-ai-dev" do
  ...
  version "2.44.0-rc.64"

  arch_suffix = Hardware::CPU.intel? ? "x64" : "arm64"

  if Hardware::CPU.intel?
    sha256 "2257e3c26d489cef6872f4fefa7b739ddaa263ecad458642a3eb90eb2afec2d2"
  else
    sha256 "0e3e988b608b6f570029fa79932062a0ddb764bebbf3fddede859cd991c28060"
  end
