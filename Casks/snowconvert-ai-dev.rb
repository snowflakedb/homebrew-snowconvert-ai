cask "snowconvert-ai-dev" do
  ...
  version "2.42.0-rc.350"

  arch_suffix = Hardware::CPU.intel? ? "x64" : "arm64"

  if Hardware::CPU.intel?
    sha256 "6b74020f3b0cb663cc5a1efdd1dd911a6d903f09dcb25795c63540af14f6beca"
  else
    sha256 "31bb7499152527a9ae3a050dee2b9c196d2c66b233458e22f656b05d0fea1847"
  end
