cask "snowconvert-ai-dev" do
  ...
  version "2.19.0-rc.156"

  arch_suffix = Hardware::CPU.intel? ? "x64" : "arm64"

  if Hardware::CPU.intel?
    sha256 "dc78fae97fa1dac5d1390f58df26edf99384945eda857801e7e1777228c47a3e"
  else
    sha256 "54937dbdddd167eef58a4e307e3d5aaf10af36eb71bf771da32924fc103fc4b8"
  end
