cask "snowconvert-ai-dev" do
  ...
  version "2.21.0-rc.30"

  arch_suffix = Hardware::CPU.intel? ? "x64" : "arm64"

  if Hardware::CPU.intel?
    sha256 "d162472a35869b810dfec9d053713a742964b10c4c5c601d2f7ae52977f3e392"
  else
    sha256 "7e3b2cad9feadfbec53f58324b128149ba1c9cf4e7e02ecfd3f17d995836c3e3"
  end
