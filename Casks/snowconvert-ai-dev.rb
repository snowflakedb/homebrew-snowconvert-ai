cask "snowconvert-ai-dev" do
  ...
  version "2.11.0-rc.15"

  arch_suffix = Hardware::CPU.intel? ? "x64" : "arm64"

  if Hardware::CPU.intel?
    sha256 "8c6c50b38397f3d8d416a582354a3f60fcae4708a33b40d9cb2284c3785db755"
  else
    sha256 "09939ee12bc3ee87ec5d53db57dea81e45809e4ef91bea79f0c00dfb5761cadf"
  end
