cask "snowconvert-ai-dev" do
  ...
  version "2.46.0-rc.52"

  arch_suffix = Hardware::CPU.intel? ? "x64" : "arm64"

  if Hardware::CPU.intel?
    sha256 "6dbd72d9e06313079080cb9f668c9f197f08324f474ec8e901b3b6300fd51db5"
  else
    sha256 "3570bcf0c8473720c853b05b3642e6ae12ed82055b3ef257aca91640d29acf01"
  end
