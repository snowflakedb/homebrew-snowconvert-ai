cask "snowconvert-ai-dev" do
  ...
  version "2.44.0-rc.96"

  arch_suffix = Hardware::CPU.intel? ? "x64" : "arm64"

  if Hardware::CPU.intel?
    sha256 "a53dde938c23615dd216dc7cfba123caf29c8bf378185292229491e2c3623bf6"
  else
    sha256 "f229025fb564876f4432b2487275656cb7225c224541314eb5a1a413bd11d1fc"
  end
