cask "snowconvert-ai-dev" do
  ...
  version "2.38.0-rc.56"

  arch_suffix = Hardware::CPU.intel? ? "x64" : "arm64"

  if Hardware::CPU.intel?
    sha256 "9b7b346cede667b8a450b56f2a63c0231ae8e2767d8a28d4cd91c597cf7c4f07"
  else
    sha256 "bc52dbe0527138842d8f9580b88c4410c574ce139f371f6fef46a707f4fba87e"
  end
