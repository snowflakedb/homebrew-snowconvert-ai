cask "snowconvert-ai" do
  ...
  version "2.0.57-rc.30"

  arch_suffix = Hardware::CPU.intel? ? "x64" : "arm64"

  if Hardware::CPU.intel?
    sha256 "91a648686ba31272d047373071702763fd9f3aec03964093420ab8ad6e0ad206"
  else
    sha256 "00017ac34a86918d496975c103c3cfdabf6af2a506c49ce10eeacdec9241a641"
  end
