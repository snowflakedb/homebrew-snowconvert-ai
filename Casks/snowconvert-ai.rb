cask "snowconvert-ai" do
  ...
  version "2.0.86-rc.32"

  arch_suffix = Hardware::CPU.intel? ? "x64" : "arm64"

  if Hardware::CPU.intel?
    sha256 "0d50edd68e025913898d2c364e985bfcccf8ef7c204400f95cfd5762fa521452"
  else
    sha256 "96de7f08a967a8c3965e74605343a9fc6b37a341e906d640bf21a0132c2e8b7c"
  end
