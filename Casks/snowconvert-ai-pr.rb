cask "snowconvert-ai-pr" do
  ...
  version "2.37.0-Pr.105"

  arch_suffix = Hardware::CPU.intel? ? "x64" : "arm64"

  if Hardware::CPU.intel?
    sha256 "479fef8ff220c83701dfc2e2f084b36f77a4efc1f650c04969688c4ffaef53e1"
  else
    sha256 "2d80ea77857aabbc33899c88c879bfa654fbb5f606fe4eee429117e0efb3d59a"
  end
