cask "snowconvert-ai-pr" do
  ...
  version "2.30.2-Pr.165"

  arch_suffix = Hardware::CPU.intel? ? "x64" : "arm64"

  if Hardware::CPU.intel?
    sha256 "8ee10987b0ea1a43a20c8b8a80340d5baaed65744b3210eb4b4a7b8d49b65d50"
  else
    sha256 "333200a2f41ef9e6df6ac49b06476eea1ffb2b24bc93b7cb2a456cc4cfbed80f"
  end
