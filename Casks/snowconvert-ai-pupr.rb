cask "snowconvert-ai-pupr" do
  ...
  version "2.8.0-PuPr.31"

  arch_suffix = Hardware::CPU.intel? ? "x64" : "arm64"

  if Hardware::CPU.intel?
    sha256 "4ddbebd60cfc943c508b1ac68cbac46d9337c81777fa7f45e56c83e7906e6c55"
  else
    sha256 "70b21488014d2e60c85291fdb919bbfe584bfd48bbd496407d18e41677b31f74"
  end
